    ...
    <Box
      ...
      <Container>
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          Please review and become acquainted with the following terms and conditions before using our Service. These
          terms and conditions govern your use of the Service, and you must read and comprehend them. The meaning of
          capitalized words in these terms and conditions is the same whether they are singular or plural.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
          mb='20px'>
          The terms `the Site, We, Us, or Our` refer to the Site that provides the Service throughout this agreement. A
          `Device` is any digital device that can access and use the Service, such as a computer, smartphone, or tablet.
          The term `Service` refers to the Website, and the term `You` refers to the person or legal entity who accesses
          or uses the Service.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
          mb='20px'>
          You expressly acknowledge that you have read, understood, and agreed to be bound by these Terms and Conditions
          by accessing or using our Service. These terms define all users` rights and responsibilities and establish the
        ...
        <Typography
          ...
          component='h5'
          mb='20px'>
          You are not permitted to use the Service if you disagree with any of these Terms and Conditions. You agree to
          be bound by these Terms and Conditions by accessing or using the Service.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
          mb='20px'>
          To gain access to and use our Service, you must be at least 18 years old. Individuals under the age of 18 are
          not permitted to use or access the Service.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
          mb='20px'>
          Your use of the Service is also governed by our Privacy Policy, in addition to these Terms and Conditions. We
          recommend that you carefully read and comprehend our Privacy Policy, which explains how we collect, use, and
          disclose your personal information while you use the Service, as well as your privacy rights and how the law
          protects you.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
          mb='20px'>
          Please keep in mind that the Service may contain links to third-party websites. However, to the greatest
          extent permitted by law, the Site and its suppliers will not be liable for any special, incidental, indirect,
          or consequential damages arising from or in connection with the use or inability to use the Service. This
          includes monetary damages for lost profits, data or other information, business interruption, personal injury,
        ...
        <Typography
          ...
          component='h5'
          mb='20px'>
          The Service is provided to you on an `AS IS` and `AS AVAILABLE` basis, and it may contain flaws and defects
          not covered by any warranty, express, implied, statutory, or otherwise. The Site, its affiliates, licensors,
          and service providers expressly disclaim all warranties, including but not limited to implied warranties of
          merchantability, fitness for a particular purpose, title, and non-infringement, to the fullest extent
          permitted by law. Furthermore, the Site makes no warranties about the Service`s compatibility with other
          software, applications, systems, or services, its continuous operation, its performance or reliability, or the
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          The Site makes no guarantees that the Service will meet your specific requirements, produce the desired
          results, or be error-free. Furthermore, the Site makes no representations or warranties regarding the
          accuracy, reliability, or currency of any information or content made available through the Service. The Site
          also makes no representation that the Service, its servers, the content, or any emails sent from or on behalf
          of the Site are free of viruses, scripts, trojan horses, worms, malware, time bombs, or other potentially
          harmful components.
        </Typography>
        <Typography
          variant='h6'
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          This website is operated by {meta.title}. Throughout the site, the terms “we”, “us” and “our” refer to{' '}
          {meta.title}. {meta.title} offers this website, including all information, tools and services available from
        ...
        <Typography
          ...
          the right to limit or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers or
          distributors. You agree to provide current, complete and accurate purchase and account information for all
          purchases made at our store. You agree to promptly update your account and other information, including your
        ...
        <Typography
          ...
          websites. Please review carefully the third-party&apos;s policies and practices and make sure you understand
          them before you engage in any transaction. Complaints, claims, concerns, or questions regarding third-party
        ...
        <Typography
          ...
          further agree that your comments will not contain libelous or otherwise unlawful, abusive or obscene material,
          or contain any computer virus or other malware that could in any way affect the operation of the Service or
          any related website. You may not use a false e-mail address, pretend to be someone other than yourself, or
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          Your submission of personal information through the store is governed by our . To view our Privacy Policy.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          In no case shall *organizational name*, our directors, officers, employees, affiliates, agents, contractors,
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          You agree to indemnify, defend and hold harmless *organizational name* and our parent, subsidiaries,
        ...
        <Typography
          ...
          construed in accordance with the laws of *state/country*, without regard to its conflict of laws rules.
        </Typography>
        <Typography
          variant='h6'
          component='h5'
        ...
        <Typography
          ...
          component='h5'
          mb='10px'>
          Questions about the Terms of Service should be sent to us at {footer.contactsBlock.contacts[2].text}
        </Typography>
      </Container>
    </Box>
  );
